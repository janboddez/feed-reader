...
namespace Feed_Reader\Doctrine\Inflector\Rules\Spanish;
...
class Inflectible
{
    ...
    {
        (yield new Transformation(new Pattern('/ú([sn])$/i'), 'Feed_Reader\\u\\1es'));
        (yield new Transformation(new Pattern('/ó([sn])$/i'), 'Feed_Reader\\o\\1es'));
        (yield new Transformation(new Pattern('/í([sn])$/i'), 'Feed_Reader\\i\\1es'));
        (yield new Transformation(new Pattern('/é([sn])$/i'), 'Feed_Reader\\e\\1es'));
        (yield new Transformation(new Pattern('/á([sn])$/i'), 'Feed_Reader\\a\\1es'));
