...
<div class="wrap">
	...
	<form action="options.php" method="post">
		...
		<table class="form-table">
			...
			<tr valign="top">
				<th scope="row"><label for="feed_reader_settings[image_proxy_secret]"><?php esc_html_e( 'Image Proxy Secret', 'feed-reader' ); ?></label></th>
				<td>
					<input type="text" name="feed_reader_settings[image_proxy_secret]" id="feed_reader_settings[image_proxy_secret]" value="<?php echo ! empty( $options['image_proxy_secret'] ) ? esc_attr( $options['image_proxy_secret'] ) : ''; ?>" />
