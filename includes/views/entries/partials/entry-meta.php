...
<div class="entry-meta">
	<?php if ( ! empty( $entry->author ) ) : ?>
		<a href="<?php echo esc_url( \Feed_Reader\get_url( 'feeds', 'view', $entry->feed_id ) ); ?>"><?php echo esc_html( $entry->author ); ?></a>
		<span aria-hidden="true">&bull;</span>
	<?php elseif ( ! empty( $entry->feed_name ) ) : ?>
		<a href="<?php echo esc_url( \Feed_Reader\get_url( 'feeds', 'view', $entry->feed_id ) ); ?>"><?php echo esc_html( $entry->feed_name ); ?></a>
		<span aria-hidden="true">&bull;</span>
	<?php endif; ?>
